...
# if [ $ANDROID = "TRUE" ]; then
# 	echo ""
# 	for propfile in *build.prop; do
# 		{
# 			if [ -f "$propfile" ]; then
# 				echo "$propfile"
# 				cp "$propfile" build.prop
# 				sh "$TDIR"/mHideGP.sh > /dev/null
# 				rm build.prop
# 			fi
# 		}
...
#     for propfile in *default.prop; do
# 		{
# 			if [ -f "$propfile" ]; then
# 				echo "$propfile"
# 				cp "$propfile" default.prop
# 				sh "$TDIR"/mHideGP.sh > /dev/null
# 				rm default.prop
# 			fi
# 		}
...
#     for propfile in *prop.default; do
# 		{
# 			if [ -f "$propfile" ]; then
# 				echo "$propfile"
# 				cp "$propfile" prop.default
# 				sh "$TDIR"/mHideGP.sh > /dev/null
# 				rm prop.default
# 			fi
# 		}
...
#     for propfile in *getprop.props; do
# 		{
# 			if [ -f "$propfile" ]; then
# 				echo "$propfile"
# 				# cp "$propfile" getprop.props
# 				mv "$propfile" getprop.props
# 				sh "$TDIR"/mHideGP.sh > /dev/null
# 				# rm getprop.props
# 			fi
# 		}
